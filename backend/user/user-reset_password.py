...
MSG_SUCCESS = {"status": 200, "statusText": "The user's password has been successfully reset.", "body": {}}
MSG_FAIL_TO_CREATE = {"status": 422, "statusText": "The user's password could not be reset.", "body": {}}
...
if __name__ == "__main__":
    body = {
        ...
        "user_password": "Prado-222156",
        "new_user_password" : "Prado-156",
        "confirm_new_user_password" : "Prado-156"
        }
